...
export function NumberStepperInput({ value, onChange, min = 0, max = 99, step = 1, placeholder, light = false }: IProps) {
  const L = light;
  ...
  return (
    <div
      className={`flex items-center overflow-hidden rounded-lg border transition-colors focus-within:border-[#d4af37]/40 ${
