...
export const FinalCTA: FC<IProps> = ({ mode }) => {
        ...
        <div className="flex flex-col gap-12 py-24 items-center">
            <div className="flex flex-col gap-7 items-center">
                ...
                <p className="font-body text-center text-base md:text-lg text-white/50 mb-7 md:mb-9 max-w-[650px] leading-relaxed">
                    {`Разместите одну анкету или добавьте сразу несколько ${isMassageMode ? 'мастеров' : 'моделей'}. Размещение бесплатно, комиссия взимается только с состоявшейся сделки.`}
                </p>
            </div>
