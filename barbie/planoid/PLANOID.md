...
- **Operator memory** `C:\Users\a3\.claude\projects\F--Users-a-Documents--DEV-Tran-ES\memory\` — Claude Code auto-memory, cross-chat, indexed by `MEMORY.md`. Governs durable facts.
