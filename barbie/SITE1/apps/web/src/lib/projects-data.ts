...
export const PROJECTS: ReadonlyArray<Project> = [
  ...
  {
    id: 'imperiumspa',
    domain: 'imperiumspa.ru',
    name: 'Imperium',
    tagline: 'Эротический массаж в римском стиле · Москва',
  ...
  },
  {
    ...
    domain: '5massage.ru',
    name: '5MASSAGE',
    tagline: 'VANILIA · тёплый дом для особенных вечеров',
  ...
  {
    id: 'massazh-dlya-par',
    domain: 'massazh-dlya-par.ru',
    name: 'PARA',
    tagline: 'Эромассаж для пар · Москва',
    phones: ['+7 (495) 000-00-00', '+7 (495) 000-00-00'],
    bg: '#14101A',
    headColor: '#F4ECF2',
    headFont: 'Inter',
    accColor: '#C08497',
    ...
    bodyColor: '#CFC6D2',
    bodyFont: 'Inter',
    site: '/massazh-dlya-par',
  },
  {
    id: 'outcall-massage',
    domain: 'outcall-massage.ru',
    name: 'OUTCALL',
    tagline: 'Выездной массаж · Москва и область',
    phones: ['+7 (495) 000-00-00', '+7 (495) 000-00-00'],
    bg: '#0F1115',
    headColor: '#EEF1F5',
    headFont: 'Inter',
    ...
    bodyColor: '#C3C8D0',
    bodyFont: 'Inter',
    site: '/outcall-massage',
  },
  // ── Не из нашей сети (wellness-ретрит, не эро-массаж салон) — держим в конце деки.
  {
    id: 'dacha',
    domain: 'dachaspa.ru',
    name: 'DACHA',
