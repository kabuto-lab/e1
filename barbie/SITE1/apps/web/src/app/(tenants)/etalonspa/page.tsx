    ...
    <EtalonShell>
        ...
        <div className="wrap hero-grid">
          <div>
            ...
            <div className="btn-row">
              <a href="/etalonspa/programs" className="btn">Записаться на массаж</a>
              <a href="/etalonspa/staff" className="btn btn-ghost">Подобрать девушку</a>
            </div>
          </div>
      ...
      <section style={{ background: 'var(--bg-2)' }}>
        <div className="wrap">
          ...
          <div style={{ textAlign: 'center', marginTop: '40px' }}><a href="/etalonspa/programs" className="btn">Все программы</a></div>
        </div>
      </section>
      ...
      <section style={{ background: 'var(--bg-2)' }}>
        <div className="wrap about">
          ...
          <div>
            ...
            <a href="/etalonspa/interior" className="btn btn-ghost" style={{ marginTop: '10px' }}>Наш интерьер</a>
          </div>
        </div>
      </section>
      ...
      <section>
        <div className="wrap">
          <div className="contact-strip">
            ...
            <a href="/etalonspa/contacts" className="btn">Контакты и карта</a>
          </div>
        </div>
      </section>
    </EtalonShell>
