    ...
    <EroticmassajShell>
      ...
      <section style={{ paddingTop: '14px' }}>
        <div className="container" style={{ display: 'grid', gridTemplateColumns: '1fr 1.3fr', gap: '34px', alignItems: 'start' }}>
          ...
          <img src="/tenants/eroticmassaj/solyarij-1.webp" alt="Мы рады не только мужчинам.." style={{ width: '100%', borderRadius: '16px', border: '1px solid var(--line)', objectFit: 'cover' }} />
          <div className="prose">
