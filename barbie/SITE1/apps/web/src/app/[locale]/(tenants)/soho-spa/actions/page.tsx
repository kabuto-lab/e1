      ...
      <section className="sec" style={{ marginTop: '70px' }}>
        <div className="wrap">
          ...
          <div className="grid g3">
            <div className="acard">
              <img src={asset("/tenants/soho-spa/Soho-eshhe-30-minut-512x512.webp")} alt="Ещё 30 минут" loading="lazy" referrerPolicy="no-referrer" />
              <div className="ab">
                <h3>⏳ Ещё 30 минут</h3>
            ...
            <div className="acard">
              <img src={asset("/tenants/soho-spa/IMG_8497com-512x512.webp")} alt="Счастливые часы" loading="lazy" referrerPolicy="no-referrer" />
              <div className="ab">
            ...
            <div className="acard">
              <img src={asset("/tenants/soho-spa/women-model-long-hair-brunette-ass-in-bed-304215-wallhere.com_-512x512.webp")} alt="Эксклюзивное поздравление" loading="lazy" referrerPolicy="no-referrer" />
              <div className="ab">
            ...
            <div className="acard">
              <img src={asset("/tenants/soho-spa/scale_1200-512x512.webp")} alt="Баллы = Рубли" loading="lazy" referrerPolicy="no-referrer" />
              <div className="ab">
                <h3>Баллы = Рубли</h3>
            ...
            <div className="acard">
              <img src={asset("/tenants/soho-spa/dlya-soho.webp")} alt="Реферальная система" loading="lazy" referrerPolicy="no-referrer" />
              <div className="ab">
            ...
            <div className="acard">
              <img src={asset("/tenants/soho-spa/poczelui.webp")} alt="Подарочный сертификат" loading="lazy" referrerPolicy="no-referrer" />
              <div className="ab">
          ...
          <div style={{ textAlign: 'center', marginTop: '40px' }}>
            <a href={asset("/soho-spa/contacts")} className="btn">Воспользоваться акцией</a>
          </div>
        </div>
      </section>
    </SohoShell>
