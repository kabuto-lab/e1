...
import { WfyVacanciesController } from './wfy-admin/wfy-vacancies.controller';
import { WfyVacanciesService } from './wfy-admin/wfy-vacancies.service';
